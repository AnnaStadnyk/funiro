...
import { Autoplay, Navigation, Pagination, Parallax, EffectCreative } from 'swiper/modules';
Swiper.use([Navigation, Pagination, Autoplay, Parallax, EffectCreative]);
...
import { products, getCurrentPage, setCurrentPage, getPageCount, loadProducts } from "./products.js";
